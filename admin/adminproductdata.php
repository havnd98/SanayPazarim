...
$dbproducts = $db->prepare("SELECT * FROM productoffers where id=:pdid");
            ...
            <div class="row gx-4 gx-lg-5 align-items-center">
                ...
                <div class="col-md-6">
                    ...
                    <h1 class="display-5 fw-bolder">
                        ...
                        echo $dbproductsoffersdata['productsName'];
                        ?>
                        

                    </h1>
                    <div class="fs-5 mb-5">
                        <span><?php echo $dbproductsoffersdata['offerCreateTime'] . " - " . $dbproductsoffersdata['offerFinishedTime'] ?></span>
                    </div>
                    <p class="lead"><?php echo $productsdata['offerHead'] ?></p>
                    Teklif Fiyat<p class="lead"><?php echo $productsdata['offerValue'] ?></p>
